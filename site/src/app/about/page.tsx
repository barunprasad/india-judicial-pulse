        ...
        <div className="doc">
          <div className="prose">
            ...
            <p>
              ...
              costs almost nothing to run, and every number is traceable to a dated, public record. The
              method and the <a href="/data">raw data</a>{" "}are open for anyone to inspect or reuse.
            </p>
            <p>
